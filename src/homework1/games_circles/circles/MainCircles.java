...
public class MainCircles extends JFrame implements GameCanvasListener {
    ...
    public void checkMouseButton(MouseEvent event) {
        switch (event.getButton()) {
            case 1:
                gameObjects = createNewObject(new Ball());
                break;
            case 3:
                gameObjects = removeObject(new Ball());
                break;
            default:
    ...
    private GameObject[] createNewObject(Ball ball) {
    ...
    private GameObject[] removeObject(Ball ball) {
